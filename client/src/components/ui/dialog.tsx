...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        "fixed z-50 grid w-full border bg-background shadow-lg duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 overflow-y-auto " +
        "left-0 bottom-0 top-auto translate-x-0 translate-y-0 rounded-t-2xl p-4 pb-6 max-h-[92vh] gap-3 " +
        "sm:left-[50%] sm:top-[50%] sm:bottom-auto sm:translate-x-[-50%] sm:translate-y-[-50%] sm:rounded-lg sm:p-6 sm:max-w-lg sm:max-h-[90vh] sm:gap-4 " +
